...
ROM_top_calculations = function(ROM_top_t,
  ...
  substrate_ROM_decomp_top = ROM_top_t - (ROM_top_t + ROM_decomposition) # ROM_top_t - ROM_decomposition
  em_CO2_ROM_top = substrate_ROM_decomp_top * s_config[['f_co2']]
  ROM_transport = (ROM_top_t+ROM_decomposition)  * s_config[['ftr']] #substrate_ROM_decomp_top * s_config[['ftr']] 
